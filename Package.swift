...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g2a72d3010f/BNBFaceTrackerLite.zip",
            checksum: "f7977c3eddc1276321bf779aff6d8370cc7d3fb5c2ec0970088f7e6cb07798e2"
        ),
        .target(
