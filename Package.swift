...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBFaceTrackerLite.zip",
            checksum: "09cd9445123ec2a1c702cdf12759f09695cd31ace5eb4834bf66837fa1082b5b"
        ),
        .target(
