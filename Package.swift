...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBFaceTrackerLite.zip",
            checksum: "0e5db24a76d322d83676bcaa54c1ef5b16c7976517ec0f7cc9dbfa22270f04c0"
        ),
        .target(
