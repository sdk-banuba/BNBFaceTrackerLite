...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-74-g9d1b0a47e/BNBFaceTrackerLite.zip",
            checksum: "7bb58bd1560bc5a82044f6e653420f8a00ea567521dd2f4f5ab750a23102802e"
        ),
        .target(
