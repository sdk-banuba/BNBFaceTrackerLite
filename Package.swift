...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-204-g6de1b78ed5/BNBFaceTrackerLite.zip",
            checksum: "42ff2d56904d33311fde87852bd790723a9432507d05e0a530e8e3ed855e9fcd"
        ),
        .target(
