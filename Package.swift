...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.3-95-g54f78c5d8b/BNBFaceTrackerLite.zip",
            checksum: "799de5fc348122f6944c1d8d08b393dea8a2c5666558648868eaafb60e7518c3"
        ),
        .target(
