...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gec24d1c86/BNBFaceTrackerLite.zip",
            checksum: "22c76a869382e4a0244c66d7d3a82d77dc02b5102d474ec1b984434016656ca5"
        ),
        .target(
