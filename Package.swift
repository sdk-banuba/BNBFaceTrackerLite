...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBFaceTrackerLite.zip",
            checksum: "74147ff885c29d30031a4ff1febf44eb27b48d5b04f6fc65bfbcc1331dcc0f47"
        ),
        .target(
