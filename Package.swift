...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-215-g9f21b13b23/BNBFaceTrackerLite.zip",
            checksum: "79f31df598f32cc46ddf33170c3cb0dc2a1318223062c922eae7dda12ff0c20f"
        ),
        .target(
