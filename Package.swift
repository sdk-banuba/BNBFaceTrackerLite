...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBFaceTrackerLite.zip",
            checksum: "caf501e186b083f060203f59da7f0e67bc352a6ededb5a038b140ebef9ba9552"
        ),
        .target(
