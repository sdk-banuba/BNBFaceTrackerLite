...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-174-gec051bdc7/BNBFaceTrackerLite.zip",
            checksum: "2ecfdc15e117c8ec1b516ca2c9328402d5a5c06f2ec03a8c6ca3e7a86136e122"
        ),
        .target(
