...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-67-g77a5e386d/BNBFaceTrackerLite.zip",
            checksum: "745c8d5dbb9b3669b2fdfd0ef69289eb608b1c7c3403fc85ba4c40156b184ae7"
        ),
        .target(
