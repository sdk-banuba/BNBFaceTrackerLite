...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-219-gefae079ac3/BNBFaceTrackerLite.zip",
            checksum: "7f03c7dfd424354076da1f529a6a1b11940500486a1a31240bc7fe2be7784a01"
        ),
        .target(
