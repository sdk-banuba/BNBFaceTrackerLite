...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-180-gd5fc258816/BNBFaceTrackerLite.zip",
            checksum: "93a40fe8ee6e894ae6621932549edd699098a39787dcffa16c008f5c36d3dd19"
        ),
        .target(
