...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9ce64ef1c2/BNBFaceTrackerLite.zip",
            checksum: "f84f66f03200291101ca6546e660e9f3713b70b9d441f75c6b8a188b8029773c"
        ),
        .target(
