...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-242-g622cf17fa4/BNBFaceTrackerLite.zip",
            checksum: "c8990c3b5d3839e3adfeb68ab6c460b50ffe372381a69f1e9ca4453f95cd1d84"
        ),
        .target(
