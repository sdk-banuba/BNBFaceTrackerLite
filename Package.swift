...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBFaceTrackerLite.zip",
            checksum: "2606da47a3373d1b37061d03926d1024d6589947bc487acb7f7b2074c96627b7"
        ),
        .target(
