...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-138-g40eb4c9af/BNBFaceTrackerLite.zip",
            checksum: "4cf77a45ced799105f8d47ebd75dcd03e761a80550c49e8c952c3fc6a1ed80a3"
        ),
        .target(
