...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-33-gdff1aad66/BNBFaceTrackerLite.zip",
            checksum: "067aa8d11d12029ff1d7713e6254675f4ec524324da8f91e4dc4180cdcfb1d22"
        ),
        .target(
