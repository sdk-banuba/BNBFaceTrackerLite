...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBFaceTrackerLite.zip",
            checksum: "747702ed29cc6ed189426130af1d36b015609ab347b18e80551fec425bd9ea32"
        ),
        .target(
