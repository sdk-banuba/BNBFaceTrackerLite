...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.15.1-1-g11945c35fb/BNBFaceTrackerLite.zip",
            checksum: "70a67b194b61a45d37a837d3067852f77d3de41b326e8d0dcfd201e8103218da"
        ),
        .target(
