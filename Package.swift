...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.2-44-g649e5173b/BNBFaceTrackerLite.zip",
            checksum: "336bdac99d079e5d04fcf679378557cef8fdc830020a8573fe5701f594dcd89f"
        ),
        .target(
