...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gcf256de1ef/BNBFaceTrackerLite.zip",
            checksum: "dc8e81fe798f7a265644dc0a1094a6e751ed56b5fd01809eccae5c56c28755db"
        ),
        .target(
