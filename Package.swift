...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-61-gc1c7cef54/BNBFaceTrackerLite.zip",
            checksum: "79c0c9f9cc77ee8b0cba5482d77818838dc5b079ea8fa6c171a5daeef662637d"
        ),
        .target(
