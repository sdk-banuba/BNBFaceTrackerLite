...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-19-gb88228b6f/BNBFaceTrackerLite.zip",
            checksum: "b21314f5cc8921d0757e6c6263fd406d621cf97e545bc717c53cf2f86296b1bc"
        ),
        .target(
