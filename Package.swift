...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-175-g35e1b614c0/BNBFaceTrackerLite.zip",
            checksum: "29e1874c6738c163361368c8140330ea8401e5c7de20daf8c8134f61d7390e7d"
        ),
        .target(
