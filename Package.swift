...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.13.0-1-g971efc62f/BNBFaceTrackerLite.zip",
            checksum: "96b040b286e62015426452514bd462a2137209828f36e021f7ee75116b07d73f"
        ),
        .target(
