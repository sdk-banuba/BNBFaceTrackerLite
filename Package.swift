...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBFaceTrackerLite.zip",
            checksum: "5acbcaef80532ecc06acafede5e17f067c83ff06a3888393219baa512dc0359d"
        ),
        .target(
