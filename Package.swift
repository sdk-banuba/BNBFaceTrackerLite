...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-33-g6de24312a/BNBFaceTrackerLite.zip",
            checksum: "e98f12403823354eafe03b2e807cae0bd8c1d24ee6f7fe962a615e7a1b0dd8cc"
        ),
        .target(
