...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gfc3672a53b/BNBFaceTrackerLite.zip",
            checksum: "4f9f21a96e99d919d36acc789ee91eb302dcb04c99de18e445b7c15c96a5508b"
        ),
        .target(
