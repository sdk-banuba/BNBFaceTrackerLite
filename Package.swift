...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-1-ge047381c9/BNBFaceTrackerLite.zip",
            checksum: "7c5b4e0fed2a3b36a4824ffa19879b4dedbf0f1d926e85f66058e7c0ca3ea187"
        ),
        .target(
