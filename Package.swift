...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-53-g189d46433/BNBFaceTrackerLite.zip",
            checksum: "59266eebe599a9f8a3554790a4814f47e2f08f2c824ec10f0c4a26b93ea6e193"
        ),
        .target(
