...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-68-g8184560bc/BNBFaceTrackerLite.zip",
            checksum: "9d6152aa46b9829afb521add7f6de3cf7faab2faad010ff90c96a748d8b6b968"
        ),
        .target(
