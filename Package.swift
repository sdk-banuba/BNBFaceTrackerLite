...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBFaceTrackerLite.zip",
            checksum: "a798bbf60d327ab889f3a80b5f04cc33e47bbdc1047c545c01d1eb3929fa7ae2"
        ),
        .target(
