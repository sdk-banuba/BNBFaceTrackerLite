...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBFaceTrackerLite.zip",
            checksum: "b7af10a13e80516015d251f654407dbd72286755b8032c0da9c605e5bd6b3915"
        ),
        .target(
