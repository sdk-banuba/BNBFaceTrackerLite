...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-g3b9a032012/BNBFaceTrackerLite.zip",
            checksum: "46d7f1cb304a586ba5ee7d484d103ce8bbe243b7ef588e43e335127b5af0ecac"
        ),
        .target(
