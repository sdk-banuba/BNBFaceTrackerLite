...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-86-g65c1c833d4/BNBFaceTrackerLite.zip",
            checksum: "1df4dd0a80dbf2b6f5f42826fac9fd89e7497c02912b4f3e7cfc962ce3cfe32d"
        ),
        .target(
