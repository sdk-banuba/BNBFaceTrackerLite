...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-218-g91528edbf1/BNBFaceTrackerLite.zip",
            checksum: "05e5f4d046aa67c50638599221b0c063cdda8068e58e92793c06cec455ea703d"
        ),
        .target(
