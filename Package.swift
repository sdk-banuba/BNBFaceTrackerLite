...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-143-g50b5f987b/BNBFaceTrackerLite.zip",
            checksum: "23f332c0de4edc8f19ed7f1b80b469cf8dd0c92f58b2745ef8acfdf9ff96968b"
        ),
        .target(
