...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-106-g81956e5c7/BNBFaceTrackerLite.zip",
            checksum: "afb9f6174d487240918fcbc4b5665c24e954481f5731e5fd372649388bc20abf"
        ),
        .target(
