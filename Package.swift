...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-86-gb002ed1e38/BNBFaceTrackerLite.zip",
            checksum: "74b0be4918147d8a67701861a1b070fc5fbbd9fce9ce60b9cef978317c3de713"
        ),
        .target(
