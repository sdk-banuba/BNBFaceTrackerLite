...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-38-g9a4283c65/BNBFaceTrackerLite.zip",
            checksum: "e9dbbf139ee6e458a7e1fede212010628eebeafba9f27cf71bf46c81ef0f1973"
        ),
        .target(
