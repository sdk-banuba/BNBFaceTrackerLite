...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBFaceTrackerLite.zip",
            checksum: "5583152fe8e54faafed1d3673f9aededd3de03df4319c42f64ae8719a59f9c99"
        ),
        .target(
