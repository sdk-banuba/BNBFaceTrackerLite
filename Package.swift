...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.3-43-gc75a0b291/BNBFaceTrackerLite.zip",
            checksum: "e59f442b43f221fc10003cd5faf671f2f6bfa3993afadf370a5d6d04ed67e201"
        ),
        .target(
