...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g079acbf0ae/BNBFaceTrackerLite.zip",
            checksum: "12d1637da7e331f28998c773029a68b6f71d1e162d1329d4855d878de82bed7d"
        ),
        .target(
