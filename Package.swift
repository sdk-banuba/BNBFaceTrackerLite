...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBFaceTrackerLite.zip",
            checksum: "52408a63f7de69ade528e68b180fcdd89658d8e7252c9a154e5240146307718e"
        ),
        .target(
