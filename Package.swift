...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-271-g70b8136591/BNBFaceTrackerLite.zip",
            checksum: "bb2b4d97078153c78b7833c471fa9999e72f550514cda60d102420d48340b0ca"
        ),
        .target(
