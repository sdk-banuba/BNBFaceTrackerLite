...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-217-g36d3a95c51/BNBFaceTrackerLite.zip",
            checksum: "c43f842b452c3b7156ee7ecab1b67b4a68b906459cbb9f6039239ac1e2ecb7ad"
        ),
        .target(
