...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-4-g0bf2ba10e/BNBFaceTrackerLite.zip",
            checksum: "ea23a899a9bcfc2e15942d7490563fbd8af359dc0dc94b01422aa3b1896047ac"
        ),
        .target(
