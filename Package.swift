...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBFaceTrackerLite.zip",
            checksum: "04269686be029ac8cf01c9ca933228e12391d2d37a09cd2c6527ee02f33e80cd"
        ),
        .target(
