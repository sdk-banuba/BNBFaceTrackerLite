...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g9f1f1a3b1/BNBFaceTrackerLite.zip",
            checksum: "552352b25a4018295a56bf928730f0d56504e58a60e90c47b8ebcf237438f402"
        ),
        .target(
