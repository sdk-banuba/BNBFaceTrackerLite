...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.0-9-g9cd2ba648/BNBFaceTrackerLite.zip",
            checksum: "c1a69cfd27527e06c8ba516817011677a1058b90ce3601e3cdac21c04ed5c740"
        ),
        .target(
