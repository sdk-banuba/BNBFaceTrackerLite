...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTrackerLite",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBFaceTrackerLite.zip",
            checksum: "2ab38da417bec263f698da718ea0cdff8db0efed8ce568c4b2f73fec9983e64b"
        ),
        .target(
